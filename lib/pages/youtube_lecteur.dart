...
class LecteurYoutubePage extends StatefulWidget {
  YoutubeAPI ytApi;
  ...
  LecteurYoutubePage(
      {Key key,
        ...
        this.ytApi,
        this.ytApiPlaylist,
        this.ytResultPlaylist,this.url,this.titre})
      : super(key: key);

  @override
  State<LecteurYoutubePage> createState() => _LecteurYoutubePageState();
}

class _LecteurYoutubePageState extends State<LecteurYoutubePage> {
